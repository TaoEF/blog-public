...
This is the durable project knowledge base for AI-assisted development.

## Read First

1. `.project-wiki/schema.md`
2. Relevant architecture, module, feature, contract, or decision pages
3. Source-of-truth code files listed in selected pages
